SECRET_KEY = 'django-insecure-icv5vc8)n6#ka11eiw)i83v8n5-azyw&gikpin7mh^gxlf_99^'
import os
...
WSGI_APPLICATION = 'rokna.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / 'cafe/static',  # App-level static files
]
